...
import vn.giabaochatapp.giabaochatappserver.config.exception.InvalidPermissionDataException;
import vn.giabaochatapp.giabaochatappserver.config.exception.NotFoundException;
import vn.giabaochatapp.giabaochatappserver.config.exception.PermissionInUseException;
import vn.giabaochatapp.giabaochatappserver.data.domains.Permission;
import vn.giabaochatapp.giabaochatappserver.data.dto.shortName.PermissionDTO;
